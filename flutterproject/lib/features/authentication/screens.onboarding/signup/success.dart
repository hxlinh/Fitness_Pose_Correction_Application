      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            children: [
              // Image
              Image(image: const AssetImage(AppImages.staticSuccessIllustration), width: AppHelperFunctions.screenWidth() * 0.6),
              ...
              // Buttons
              SizedBox(width: double.infinity, child: ElevatedButton(style:ElevatedButton.styleFrom(backgroundColor:  Color(0xFF98FF98),foregroundColor: Colors.black,side: BorderSide(color: Colors.white, width: 0)) ,onPressed: () => Get.to(() => const LoginScreen()), child: const Text(AppTexts.appcontinue))),
